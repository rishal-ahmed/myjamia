                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      SizedBox(
                        height: 40,
                        child: Text(
                          title.toString().length < 41 ? title.toString() : title.toString().substring(0, 40),
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            price!,
                            style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w400, color: kTextLightColor),
                          ),
                        ],
                      )
                    ],
