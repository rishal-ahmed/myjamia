...
import 'package:myjamia/screens/bundle_details_screen.dart';
import 'package:myjamia/screens/my_bundle_courses_list_screen.dart';
                ...
                children: <Widget>[
                  ClipRRect(
                    ...
                    child: FadeInImage.assetNetwork(
                      ...
                      image: '$BASE_URL/uploads/course_bundle/banner/${myBundle!.banner}',
                      height: 120,
                      width: double.infinity,
                      fit: BoxFit.cover,
                    ),
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    SizedBox(
                      height: 42,
                      child: CustomText(
                        text: myBundle!.title!.length < 38 ? myBundle!.title : myBundle!.title!.substring(0, 37),
                        fontSize: 14,
                    ...
                    Row(
                      children: [
                        CircleAvatar(
                          radius: 11,
                          backgroundImage: NetworkImage(myBundle!.userImage.toString()),
