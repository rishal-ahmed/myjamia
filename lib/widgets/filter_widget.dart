...
class _FilterWidgetState extends State<FilterWidget> {
    ...
    try {
      if (_selectedSubCat != null) {
        await Provider.of<Courses>(context, listen: false)
            .filterCourses(_selectedSubCat, _selectedPrice, _selectedLevel, _selectedLanguage, _selectedRating);
      } else {
        await Provider.of<Courses>(context, listen: false)
            .filterCourses(_selectedCategory, _selectedPrice, _selectedLevel, _selectedLanguage, _selectedRating);
      }
  ...
  Widget build(BuildContext context) {
    ...
    catData.insert(0, Category(id: 0, title: 'All Category', thumbnail: null, numberOfCourses: null, numberOfSubCategories: null));
    //print(catData);
    final langData = Provider.of<Languages>(context, listen: false).items;
    langData.insert(0, Language(id: 0, value: 'all', displayedValue: 'All Language'));
    final allCategory = Provider.of<Categories>(context, listen: false).allItems;
    allCategory.insert(0, AllCategory(id: 0, title: 'All Category', subCategory: data));
    return _isLoading
                            ...
                            Card(
                              ...
                              child: Padding(
                                ...
                                child: DropdownButton(
                                  ...
                                  isExpanded: true,
                                  items: DifficultyLevel.getDifficultyLevel().map((dl) {
                                    return DropdownMenuItem(
                                      value: dl.id,
                                      child: Text(
                                        dl.name,
