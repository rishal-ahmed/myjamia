import 'package:myjamia/screens/courses_screen.dart';
...
class SubCategoryListItem extends StatelessWidget {
  ...
  const SubCategoryListItem(
      {Key? key, @required this.id, @required this.title, @required this.parent, @required this.numberOfCourses, @required this.index})
      : super(key: key);
