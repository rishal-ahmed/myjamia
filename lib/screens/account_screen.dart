...
import 'package:myjamia/widgets/account_list_tile.dart';
                        ...
                        CircleAvatar(
                          ...
                          child: ClipRRect(
                            ...
                            child: Image.network(
                              ...
                              errorBuilder: (_, __, ___) => const Icon(Icons.hide_image_outlined, color: kWhite),
                            ),
                          ),
                        ),
                        Padding(
                          ...
                          child: Padding(
                            ...
                            child: Card(
                              ...
                              child: GestureDetector(
                                ...
                                onTap: () async {
                                  final bool isUpdated = await Navigator.of(context).pushNamed(EditProfileScreen.routeName) as bool;
                              ...
                              child: GestureDetector(
                                ...
                                onTap: () {
                                  if (courseAccessibility == 'publicly') {
                                    ...
                                    Provider.of<Auth>(context, listen: false)
                                        .logout()
                                        .then((_) => Navigator.pushNamedAndRemoveUntil(context, '/auth-private', (r) => false));
                                  }
                                },
                              ),
                            ),
