...
class McbdThree extends StatefulWidget {
  ...
  final int bundleId;
  final int courseId;
  const McbdThree({Key? key, required this.bundleId, required this.courseId}) : super(key: key);

  @override
  State<McbdThree> createState() => _McbdThreeState();
}

class _McbdThreeState extends State<McbdThree> with SingleTickerProviderStateMixin {
