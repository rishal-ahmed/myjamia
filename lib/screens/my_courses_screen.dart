...
import 'package:myjamia/widgets/my_bundle_grid.dart';
import 'package:myjamia/widgets/my_course_grid.dart';
        ...
        if (dataSnapshot.connectionState == ConnectionState.waiting) {
          ...
          if (dataSnapshot.error != null) {
            ...
            return Consumer<MyCourses>(
              builder: (context, myCourseData, child) => StaggeredGridView.countBuilder(
          ...
          if (dataSnapshot.connectionState == ConnectionState.waiting) {
            ...
            if (dataSnapshot.error != null) {
              ...
              return Consumer<MyBundles>(
                builder: (context, myBundleData, child) => StaggeredGridView.countBuilder(
                  padding: const EdgeInsets.all(10.0),
                  shrinkWrap: true,
                  physics: const NeverScrollableScrollPhysics(),
                  crossAxisCount: 2,
