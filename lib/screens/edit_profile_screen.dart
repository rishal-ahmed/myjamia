...
import 'package:myjamia/models/user.dart';
import 'package:myjamia/providers/auth.dart';
import 'package:myjamia/widgets/app_bar_two.dart';
import 'package:myjamia/widgets/user_image_picker.dart';
...
class _EditProfileScreenState extends State<EditProfileScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      await Provider.of<Auth>(context, listen: false).updateUserData(updateUser);
                ...
                builder: (context, authData, child) {
                  ...
                  return SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        const Padding(
                          padding: EdgeInsets.only(left: 15, top: 10, bottom: 5.0),
                          child: Text(
