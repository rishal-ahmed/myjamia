...
import 'package:myjamia/widgets/lesson_list_item.dart';
                                ...
                                onTap: () {
                                  if (loadedCourse.courseOverviewProvider == 'vimeo') {
                                    ...
                                    Navigator.push(
                                        context,
                                        MaterialPageRoute(
                                            builder: (context) => PlayVideoFromVimeoId(courseId: loadedCourse.id!, vimeoVideoId: vimeoVideoId)));
                                  } else if (loadedCourse.courseOverviewProvider == 'html5') {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                          builder: (context) =>
                                              PlayVideoFromNetwork(courseId: loadedCourse.id!, videoUrl: loadedCourse.courseOverviewUrl!)),
                                    );
                                  } else {
                                    if (loadedCourse.courseOverviewProvider!.isEmpty) {
                                      ...
                                      Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                            builder: (context) =>
                                                PlayVideoFromYoutube(courseId: loadedCourse.id!, videoUrl: loadedCourse.courseOverviewUrl!),
                                          ));
                                    }
                                  }
                                },
                                      ...
                                      if (_isAuth) {
                                        ...
                                        showDialog(
                                          ...
                                          builder: (BuildContext context) =>
                                              buildPopupDialogWishList(context, loadedCourseDetail.isWishlisted, loadedCourse.id, msg),
                                        );
                                      } else {
                        ...
                        child: Row(
                          ...
                          children: <Widget>[
                            ...
                            MaterialButton(
                                  ...
                                  if (_authToken != null) {
                                    if (loadedCourse.isFreeCourse == '1') {
                                      ...
                                      Provider.of<Courses>(context, listen: false)
                                          ...
                                          .then((_) => CommonFunctions.showSuccessToast('Enrolled Successfully'));
                                    } else {
                              ...
                              color: loadedCourseDetail.isPurchased! ? kGreenPurchaseColor : kRedColor,
                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      child: TabBar(
                                        ...
                                        indicator: BoxDecoration(borderRadius: BorderRadius.circular(10), color: kRedColor),
