...
import 'package:myjamia/models/update_user_model.dart';
...
class _VerificationScreenState extends State<VerificationScreen> {
  ...
  Future<void> _resend() async {
    ...
    try {
      ...
      if (user.status == 200) {
        Navigator.of(context).pushNamed(VerificationScreen.routeName, arguments: email);
        CommonFunctions.showSuccessToast(user.message.toString());
      } else {
        CommonFunctions.showErrorDialog(user.message.toString(), context);
      }
                                    ...
                                    child: TextField(
                                      ...
                                      onChanged: (val) {
                                        if (val.isNotEmpty) {
                                          ...
                                          setState(() {
                                            _value = _controllers.fold<String>('', (prevVal, element) => prevVal + element.text);
                                          });
