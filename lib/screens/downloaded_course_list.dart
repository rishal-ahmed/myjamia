...
import 'package:myjamia/screens/download_list_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder<List<CourseDbModel>>(
        ...
        builder: (BuildContext context, AsyncSnapshot<List<CourseDbModel>> snapshot) {
          if (!snapshot.hasData) {
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    SizedBox(
                                      height: 60,
                                      child: CustomText(
                                        text: snapshot.data![index].courseTitle.length < 38
                                            ? snapshot.data![index].courseTitle
                                            : snapshot.data![index].courseTitle.substring(0, 37),
                                        fontSize: 14,
