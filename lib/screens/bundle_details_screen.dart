...
import 'package:myjamia/models/bundle_details_model.dart';
...
import 'package:myjamia/widgets/course_grid.dart';
    ...
    if (_isInit) {
      ...
      Provider.of<Bundles>(context).fetchBundleDetailById(bundleId).then((_) {
        setState(() {
          ...
          var text = html.Element.span()..appendHtml(bundles.first.bundleDetails.toString());
                      ...
                      children: <Widget>[
                        ...
                        MaterialButton(
                          onPressed: () async {
                            ...
                            if (authToken != null) {
                              if (bundles[0].subscriptionStatus == 'invalid' || bundles[0].subscriptionStatus == 'expired') {
                                final url = '$BASE_URL/api/web_redirect_to_buy_bundle/$authToken/$bundleId/academybycreativeitem';
                                _launchURL(url);
                              } else {
                                CommonFunctions.showSuccessToast('Already purchased. Check My Course.');
                              }
                            } else {
                              CommonFunctions.showSuccessToast('Please login first');
                            }
                          },
                          color: bundles[0].subscriptionStatus == 'valid' || bundles[0].subscriptionStatus == 'expired'
                              ? kGreenPurchaseColor
                              : kRedColor,
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (ctx, index) {
                        return CourseGrid(
                          ...
                          instructorName: bundles[0].bundleCourses![index].instructorName,
                          instructorImage: bundles[0].bundleCourses![index].instructorImage,
