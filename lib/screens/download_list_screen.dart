...
class DownloadListScreen extends StatefulWidget {
  final int courseId;
  final String title;
  const DownloadListScreen({Key? key, required this.courseId, required this.title}) : super(key: key);
...
class _DownloadListScreenState extends State<DownloadListScreen> {
  ...
  Future<List<Map<String, dynamic>>?> getVideos() async {
    List<Map<String, dynamic>> listMap = await DatabaseHelper.instance.queryAllRows('video_list');
    setState(() {
  ...
  Future<List<Map<String, dynamic>>?> getLessons() async {
    List<Map<String, dynamic>> listMap = await DatabaseHelper.instance.queryAllSections(widget.courseId);
    setState(() {
      for (var map in listMap) {
                        ...
                        child: ExpansionTile(
                          ...
                          title: Padding(
                            ...
                            child: Align(
                              ...
                              child: CustomText(
                                text: HtmlUnescape().convert(section.sectionTitle.toString()),
                          ...
                          children: [
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return widget.courseId == getVideo.courseId && section.sectionId == getVideo.sectionId
                                    ? Column(
                                        children: <Widget>[
                                          InkWell(
                                            onTap: () {
                                              setState(() async {
                                                path = '${getVideo.path}/${getVideo.title}';
